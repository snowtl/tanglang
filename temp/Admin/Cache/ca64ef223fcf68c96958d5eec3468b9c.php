...
<div class="wrap"> <div class="header">
 ...
 <div class="tabBox" id="Threetab">
  ...
  <div class="center_r">
    <div class="center">
      <div class="center_r_t">您的位置：<a href="<?php echo U('Shop/index');?>" class="a1">商品列表</a>>>添加/编辑商品</div>
      <div class="center_t">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
              ...
              <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                    <select id="classid" name="classid">
                        ...
                        <?php if(is_array($splist)): $i = 0; $__LIST__ = $splist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["cid"]); ?>" <?php if($vo[cid]==$info[classid]): ?>selected<?php endif; ?> ><?php echo ($vo["fullname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </td>
            </tr> 
            ...
            <tr align="left"  class="center_t_d">
                <td width="20%">活动标题</td>
                <td align="left">
                    <input type="text" name="hdtitle" id="hdtitle" size="100" value="<?php echo ($info["hdtitle"]); ?>" />
                </td>
            </tr>  
            <tr align="left"  class="center_t_d">
                <td width="20%">活动主题页面</td>
                <td align="left">
                    <input type="text" name="hdztlink" id="hdztlink" size="100" value="<?php echo ($info["hdztlink"]); ?>" />
                </td>
            </tr>  
            <tr align="left"  class="center_t_d">
                <td width="20%">商品评分</td>
                <td align="left">
                    <input type="text" name="fenshu" id="fenshu" size="20" value="<?php echo ($info["fenshu"]); ?>" />
                </td>
            </tr>  
            <tr align="left"  class="center_t_d">
                <td width="20%">商品评价数目</td>
                <td align="left">
                    <input type="text" name="comments" id="comments" size="20" value="<?php echo ($info["comments"]); ?>" />
                </td>
            </tr>  
            <tr align="left"  class="center_t_d">
                <td width="20%">图片集合<a href="javascript:addimgrow();" class="btn submit">添加</a></td>
                <td align="left">
                    <?php if(is_array($imgsrc)): $i = 0; $__LIST__ = $imgsrc;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><img src="__ROOT__<?php echo ($vo); ?>" width="100" /><br/><?php endforeach; endif; else: echo "" ;endif; ?>
            ...
            <tr align="left"  class="center_t_d">
                <td width="20%">本站价格</td>
                <td align="left">
                    <input type="text" name="price" id="price" size="20" value="<?php echo ($info["price"]); ?>" />
                </td>
            </tr> 
            <tr align="left"  class="center_t_d">
                <td width="20%">参考价格</td>
                <td align="left">
                    <input type="text" name="ckprice" id="ckprice" size="20" value="<?php echo ($info["ckprice"]); ?>" />
                </td>
            </tr> 
            <tr align="left"  class="center_t_d">
                <td width="20%">内容</td>
            ...
            <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                    <select id="is_tj" name="is_tj">
                        <?php if(is_array($goodstj)): $k = 0; $__LIST__ = $goodstj;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><option value="<?php echo ($k); ?>" <?php if($info[is_tj]==$k): ?>selected<?php endif; ?>><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </td>
            </tr>      
            <tr align="left"  class="center_t_d">
                <td width="20%">库存</td>
                <td align="left">
                    <input type="text" name="kucun" id="kucun" size="20" value="<?php echo ($info["kucun"]); ?>" />
                </td>
            </tr>   
            <tr align="left"  class="center_t_d">
                <td width="20%">评论数目</td>
