...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        <title>添加-图库-后台管理-<?php echo ($systemConfig["SITE_INFO"]["name_cms"]); ?></title>
        <meta charset="UTF-8">
 ...
 <div class="tabBox" id="Threetab">
  ...
  <div class="center_r">
    <div class="center">
      ...
      您的位置：<a href="<?php echo U('Tuku/index');?>" class="a1">图库列表</a>>>
            <a href="<?php echo U('Tuku/add_tuku');?>" class="a1">添加图库step1</a>>>添加图库step2
      </div>
      <div class="center_t">
          <form action="" method="POST" id="form1" name="form1" enctype="multipart/form-data" >
            ...
            <tr align="left"  class="center_t_d">
                <td width="20%">标题</td>
                <td align="left">
                    <input type="text" size="100" name="title" id="title" value="" />
                </td>
            </tr>
            ...
            <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                     <input type="text" size="100" name="keywords" id="keywords" value="" />
            ...
            <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                    <select name="hxid" id="hxid">
                        ...
                        <?php if(is_array($hxlist)): $i = 0; $__LIST__ = $hxlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                   </select>
                </td>
            </tr>
            <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                    <select name="jbid" id="jbid">
                        <option value="">请选择</option>
                        <?php if(is_array($jubucategory)): $i = 0; $__LIST__ = $jubucategory;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                   </select>
                </td>
            </tr>    
             <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                    <select name="sxid" id="sxid">
                        <option value="">请选择</option>
                        <?php if(is_array($sexi)): $i = 0; $__LIST__ = $sexi;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                   </select>
                </td>
            </tr>   
              <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                    <select name="fgid" id="fgid">
                        <option value="">请选择</option>
                        <?php if(is_array($fglist)): $i = 0; $__LIST__ = $fglist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                   </select>
                </td>
            </tr>   
                <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                    <select name="kjid" id="kjid">
                        <option value="">请选择</option>
                        <?php if(is_array($kjlist)): $i = 0; $__LIST__ = $kjlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                   </select>
                </td>
            </tr>   
            ...
            <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                    <select id="ysid" name="ysid">
                        <option value="">请选择</option>
                        <?php if(is_array($yslist)): $i = 0; $__LIST__ = $yslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["ysid"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </td>
            </tr>  
            <tr align="left"  class="center_t_d">
                <td width="20%">收藏数目</td>
                <td align="left">
                    <input type="text" size="10" name="shoucang" id="shoucang" value="" />
                </td>
            </tr> 
                <tr align="left"  class="center_t_d">
                <td width="20%">点击</td>
                <td align="left">
                    <input type="text" size="10" name="click" id="click" value="" />
                </td>
            </tr> 
            ...
            <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                    ...
                    <label><input type="radio" name="status" id="status" value="1" />已经审核</label>
                    <label><input type="radio" name="status" id="status" value="0" />未审核</label>
            ...
            <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                    ...
                    <label><input type="radio" name="is_tj" id="is_tj" value="1" />推荐</label>
                    <label><input type="radio" name="is_tj" id="is_tj" value="0" />普通</label>
