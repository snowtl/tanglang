...
<html>
<head>
<title>发货-后台管理-<?php echo ($systemConfig["SITE_INFO"]["name_cms"]); ?></title>
<meta charset="UTF-8">
...
<div class="wrap"> <div class="header">
  ...
  <div class="center_r">
    <div class="center">
        <div class="center_r_t">您的位置：<a href="<?php echo U('Shop/order');?>" class="a1">订单列表</a> >>发货</div>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="center_t" style="word-break:break-all; word-wrap:break-all;">
        ...
        <tr class="center_t_d">
          ...
          <td colspan='4'><form method='post' id="form" name='form' action=''><input type='text' name='fhsn' id="fhsn" value='' class="bor" />
                  <input type='hidden' name='id' id="id" value='<?php echo ($info["id"]); ?>' class="bor" />
                  
                  <input type='submit' name='sub' id="sub" value='提交' /></form></td>
        </tr>
