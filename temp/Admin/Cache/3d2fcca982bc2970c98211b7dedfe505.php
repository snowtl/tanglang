...
<html>
<head>
<title>订单详细-后台管理-<?php echo ($systemConfig["SITE_INFO"]["name_cms"]); ?></title>
<meta charset="UTF-8">
...
<div class="wrap"> <div class="header">
  ...
  <div class="center_r">
    <div class="center">
        <div class="center_r_t">您的位置： <a href="<?php echo U('Shop/order');?>" class="a1" > 订单列表</a> >>订单详细</div>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="center_t" style="word-break:break-all; word-wrap:break-all;">
          ...
          <td colspan='6'><?php echo ($info["ordersn"]); ?></td>
        </tr>  
        <tr class="center_t_d">
          <td class="td1" width="135">订单总价：</td>
          <td colspan='6'><?php echo ($info["price"]); ?></td>
        </tr>  
        <tr class="center_t_d">
          <td class="td1" width="135">配送类型：</td>
          <td colspan='6'><?php echo ($pstypef); ?></td>
        </tr>  
        <tr class="center_t_d">
          <td class="td1" width="135">配送费用：</td>
          <td colspan='6'><?php echo ($info["psprice"]); ?></td>
        </tr>  
        
        <tr class="center_t_d">
          <td class="td1" width="135">支付方式：</td>
          <td colspan='6'><?php echo ($paytypef); ?></td>
        </tr>  
        <tr class="center_t_d">
          <td class="td1" width="135">会员：</td>
          <td colspan='6'><?php echo ($uname); ?></td>
        </tr>
        <tr class="center_t_d">
          <td class="td1" width="135">状态：</td>
          <td colspan='6'><?php echo ($info["statusf"]); ?></td>
        </tr>
        <tr class="center_t_d">
          <td class="td1" width="135">创建时间：</td>
          <td colspan='6'><?php echo ($addtimef); ?></td>
        </tr>
        
        <tr class="center_t_d">
          <td class="td1" width="135">商家：</td>
          <td colspan='6'><?php echo ($company); ?></td>
        </tr>
        <tr class="center_t_d">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="center_t_d">
          ...
          <td width="80"><?php echo ($vo["num"]); ?></td>
          <td width="135"><?php echo ($vo["bz"]); ?></td>
          
          <td width="20">
        <?php if($info[status]==4): ?><a name="<?php echo ($vo["ordersn"]); ?>" link="<?php echo U('Shop/del_insorder',array('id'=>$vo[id]));?>" style="cursor:pointer" class="del">删除</a><?php endif; ?>
              </td>
