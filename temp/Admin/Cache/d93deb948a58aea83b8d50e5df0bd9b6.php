...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        <title>编辑日记-后台管理-<?php echo ($systemConfig["SITE_INFO"]["name_cms"]); ?></title>
        <meta charset="UTF-8">
 ...
 <div class="tabBox" id="Threetab">
  ...
  <div class="center_r">
    <div class="center">
      ...
      您的位置：<a href="<?php echo U('Gongzhang/index');?>" class="a1">施工动态</a>>>编辑日记
      </div>
      <div class="center_t">
          <form action="" method="POST" id="form1" name="form1" enctype="multipart/form-data" >
            ...
            <tr align="left"  class="center_t_d">
                <td width="20%">简介</td>
                <td align="left">
                    <textarea id="jianjie" name="jianjie" rows="10" cols="50"><?php echo ($info["jianjie"]); ?></textarea>
            ...
            <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                    <select name="classid" id="classid">
                        <option value="">请选择</option>
                        <?php if(is_array($rijicategory)): $i = 0; $__LIST__ = $rijicategory;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["cid"]); ?>" <?php if($vo[cid]==$info[classid]): ?>selected<?php endif; ?>><?php echo ($vo["cname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                   </select>
                </td>
            </tr>
            <tr align="left"  class="center_t_d">
                <td width="20%">点击次数</td>
                <td align="left">
                    <input type="text" size="10" name="click" id="click" value="<?php echo ($info["click"]); ?>" />平米
                </td>
            </tr>    
            ...
            <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                    ...
                    <input type="text" size="10" name="source" id="source" value="<?php echo ($info["source"]); ?>" />
            ...
            <?php if(!empty($info[fmimg])): ?><img src="__ROOT__<?php echo ($info["fmimg"]); ?>" height="100" /><?php endif; ?>
                ...
                <td width="20%">内容</td>
                <td align="left">
                    <textarea id="content" name="content" rows="10" cols="50"><?php echo ($info["content"]); ?></textarea>
