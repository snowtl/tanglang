...
<head>
<title>单页面列表-后台管理-<?php echo ($systemConfig["SITE_INFO"]["name_cms"]); ?></title>
<meta charset="UTF-8">
...
<div class="wrap"> <div class="header">
 ...
 <div class="tabBox" id="Threetab">
  ...
  <div class="center_r">
    <div class="center">
      <div class="center_r_t">您的位置：<a href="<?php echo U('Webpages/index');?>" class="a1">单页面列表</a>>>添加单页面</div>
      <div class="center_t">
        <form action="" method="POST" id="form1" name="form1" enctype="multipart/form-data">
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
            ...
            <tr align="left"  class="center_t_d">
                <td width="20%" align="right" >英文代码</td>
                <td align="left">
                    <input type="text" name="ywname" id="ywname" size="100" value="<?php echo ($info["ywname"]); ?>" />
                </td>
            </tr>
             ...
             <tr align="left"  class="center_t_d">
              ...
              <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                    <textarea id="contents" name="contents"><?php echo ($info["contents"]); ?></textarea>
                </td>
            </tr>
            <tr align="left"  class="center_t_d">
              <td colspan="2">
                  <?php if($is_qx==1): ?><input type="hidden" id="p_id" name="p_id" value="<?php echo ($p_id); ?>" />
                      <input type="hidden" id="c_id" name="c_id" value="<?php echo ($c_id); ?>" /><?php endif; ?>
