...
<head>
<title>设置已使用-后台管理-<?php echo ($systemConfig["SITE_INFO"]["name_cms"]); ?></title>
<meta charset="UTF-8">
...
<div class="wrap"> <div class="header">
 ...
 <div class="tabBox" id="Threetab">
  ...
  <div class="center_r">
    <div class="center">
      <div class="center_r_t">您的位置：<a href="<?php echo U('Shop/list_yhq');?>" class="a1">优惠券列表</a>>>设置有会员已经使用</div>
      <div class="center_t">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
            ...
            <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                    ...
                    <select id="gzid" name="gzid">
                        ...
                        <?php if(is_array($khlist)): $i = 0; $__LIST__ = $khlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["a_id"]); ?>" <?php if($info[uid]==$vo[a_id]): ?>selected<?php endif; ?>><?php echo ($vo["a_name"]); ?>[<?php echo ($vo["truename"]); ?>]</option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </td>
            </tr>
            ...
            <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                    <select id="mdid" name="mdid">
                        ...
                        <?php if(is_array($mdlist)): $i = 0; $__LIST__ = $mdlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["mdname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </td>
            </tr> 
            ...
            <tr align="left"  class="center_t_d">
              <td colspan="2">
                ...
                <input type="hidden" name="yhqid" id="yhqid" value="<?php echo ($yhqid); ?>" />
    ...
    function xzgz(){
        ...
        $.ajax({
            ...
            type:"post",
            datatype:"json",
            url:"<?php echo U('Shop/ajaxgetkehu');?>",
