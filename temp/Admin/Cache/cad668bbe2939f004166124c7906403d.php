...
<head>
<title>添加好友店铺-后台管理-<?php echo ($systemConfig["SITE_INFO"]["name_cms"]); ?></title>
<meta charset="UTF-8">
...
<div class="wrap"> <div class="header">
 ...
 <div class="tabBox" id="Threetab">
  ...
  <div class="center_r">
    <div class="center">
      <div class="center_r_t">您的位置：<a href="<?php echo U('Gongzhang/firendgx');?>" class="a1">好友店铺列表</a>>>添加添加好友店铺</div>
      <div class="center_t">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
            ...
            <tr align="left"  class="center_t_d">
                <td width="20%">好友</td>
                <td align="left">
                    <input type="text" size="100" name="gname1" id="gname1" value="" onchange="xzgz1()" placeholder="在此输入登录名进行搜索工长" /><br/>
