...
<head>
<title>优惠券使用记录-后台管理-<?php echo ($systemConfig["SITE_INFO"]["name_cms"]); ?></title>
<meta charset="UTF-8">
...
<div class="wrap"> <div class="header">
 ...
 <div class="tabBox" id="Threetab">
  ...
  <div class="center_r">
    <div class="center">
        <div class="center_r_t">您的位置：<a href="<?php echo U('Shop/list_yhq');?>" class="a1">优惠券使用记录列表</a>>><a href="<?php echo U('Shop/list_xx_yhq',array('id'=>$id));?>" class="a1">优惠券使用列表</a>>>使用详情</div>
      <div class="center_t">
