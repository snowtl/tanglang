...
<head>
<title>风格列表-后台管理-<?php echo ($systemConfig["SITE_INFO"]["name_cms"]); ?></title>
<meta charset="UTF-8">
...
<div class="wrap"> <div class="header">
 ...
 <div class="tabBox" id="Threetab">
  ...
  <div class="center_r">
    <div class="center">
      <div class="center_r_t">您的位置：<a href="<?php echo U('Fgcategory/index');?>" class="a1">风格列表</a>>>添加风格</div>
      <div class="center_t">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
            <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                    ...
                    <br/>
                    <?php if(empty($info[id])): ?>提示:添加多个风格,按Enter键<?php endif; ?>
                </td>
            </tr>
            <tr align="left"  class="center_t_d">
