...
<div class="wrap"> <div class="header">
  ...
  <div class="center_r">
    <div class="center">
      ...
      <div class="center1">
        <div class="on_line">
            <label><a href="<?php echo U('Member/shejishi');?>">设计师</a></label>
          <label><a href="<?php echo U('Member/shejishi',array('is_sq'=>1,'status'=>0));?>">未通过申请 列表</a></label>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="center_t" style="word-break:break-all; word-wrap:break-all;">
          ...
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="center_t_d">
              ...
              <a name="<?php echo ($vo["u_id"]); ?>" link="<?php echo U('Member/qx_shenqing',array('aid'=>$vo[u_id],'type'=>4));?>" style="cursor:pointer" class="shenhe">取消审核</a>
