...
<head>
<title>设置经纬度-后台管理-<?php echo ($systemConfig["SITE_INFO"]["name_cms"]); ?></title>
<meta charset="UTF-8">
...
<div class="wrap"> <div class="header">
 ...
 <div class="tabBox" id="Threetab">
  ...
  <div class="center_r">
    <div class="center">
        <div class="center_r_t">您的位置：<a href="<?php echo U('Index/city',array('id'=>$pid));?>" class="a1">返回城市列表</a>>>设置经纬度</div>
      <div class="center_t">
        <form action="" method="POST" id="form1" name="form1" enctype="multipart/form-data">
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
            <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                    <input type="text" name="jingdu" id="jingdu" size="100" value="<?php echo ($info["jingdu"]); ?>" />
                </td>
            </tr>
            <tr align="left"  class="center_t_d">
                <td width="20%" align="right" >纬度</td>
                <td align="left">
                    <input type="text" name="weidu" id="weidu" size="100" value="<?php echo ($info["weidu"]); ?>" />
                </td>
            </tr>
              
            <tr align="left"  class="center_t_d">
              <td colspan="2"><input type="hidden" id="id" name="id" value="<?php echo ($info["region_id"]); ?>" />   
