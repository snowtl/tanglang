...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        <title>添加-装修日记-后台管理-<?php echo ($systemConfig["SITE_INFO"]["name_cms"]); ?></title>
        <meta charset="UTF-8">
 ...
 <div class="tabBox" id="Threetab">
  ...
  <div class="center_r">
    <div class="center">
      ...
      您的位置：<a href="<?php echo U('Gongzhang/list_riji');?>" class="a1">装修日记</a>>>
            <a href="<?php echo U('Gongzhang/add_riji');?>" class="a1">添加装修日记step1</a>>>添加装修日记step2
      </div>
      <div class="center_t">
          <form action="" method="POST" id="form1" name="form1" enctype="multipart/form-data" >
            ...
            <tr align="left"  class="center_t_d">
                <td width="20%">简介 </td>
                <td align="left">
                    <textarea id="jianjie" name="jianjie" rows="10" cols="50">
            ...
            <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                    <select name="classid" id="classid">
                        ...
                        <?php if(is_array($rijicategory)): $i = 0; $__LIST__ = $rijicategory;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["cid"]); ?>"><?php echo ($vo["cname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                   </select>
                    <a href="<?php echo U('Gongzhang/category_riji');?>">添加日记分类</a>
                </td>
            </tr>
            <tr align="left"  class="center_t_d">
                <td width="20%">点击次数</td>
            ...
            <tr align="left"  class="center_t_d">
                <td width="20%">来源</td>
                <td align="left">
                    <input type="text" size="40" name="source" id="source" value="" />
