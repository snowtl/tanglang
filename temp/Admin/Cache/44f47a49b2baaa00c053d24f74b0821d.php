...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        <title>添加/编辑-工人-后台管理-<?php echo ($systemConfig["SITE_INFO"]["name_cms"]); ?></title>
        <meta charset="UTF-8">
...
<script type="text/javascript" src="__PUBLIC__/datepicker/js/jquery-ui-timepicker-addon.js"></script>
 ...
 <div class="tabBox" id="Threetab">
  ...
  <div class="center_r">
    <div class="center">
      <div class="center_r_t">您的位置：<a href="<?php echo U('Member/grlist');?>" class="a1">工人列表</a>>>>编辑/添加 明星工长信息</div>
      <div class="center_t">
	...
	<div>
		<span style="vertical-align: top">裁切图片：</span>
               ...
               <tr>
                ...
                <tr>
                    <td>排序：</td>
                    <td><input type="text" name="orders" size="10" id="orders" value="<?php echo ($info[orders]); ?>" /></td>
                </tr>  
                <tr>
                    <td>是否推荐：</td>
                    <td>
                ...
                <?php if($is_qx==1): ?><tr>
                    ...
                    <td>
                        ...
                        <select id="q_id" name="q_id">
                            <option value="">请选择市</option>
                            <?php if(is_array($qlist)): $i = 0; $__LIST__ = $qlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["region_id"]); ?>" <?php if($vo[region_id]==$info[q_id]): ?>selected<?php endif; ?> ><?php echo ($vo["region_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>  
