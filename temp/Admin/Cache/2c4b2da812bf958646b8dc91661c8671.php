...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        <title>编辑-图库-后台管理-<?php echo ($systemConfig["SITE_INFO"]["name_cms"]); ?></title>
        <meta charset="UTF-8">
 ...
 <div class="tabBox" id="Threetab">
  ...
  <div class="center_r">
    <div class="center">
      ...
      您的位置：<a href="<?php echo U('Tuku/index');?>" class="a1">图库列表</a>>>编辑图库
      </div>
      <div class="center_t">
          <form action="" method="POST" id="form1" name="form1" enctype="multipart/form-data" >
            ...
            <tr align="left"  class="center_t_d">
                <td width="20%">标题</td>
                <td align="left">
                    <input type="text" size="100" name="title" id="title" value="<?php echo ($info["title"]); ?>" />
                </td>
            </tr>
            
            <tr align="left"  class="center_t_d">
                <td width="20%">描述 [description]</td>
                <td align="left">
                    <textarea id="description" name="description" rows="10" cols="50"><?php echo ($info["description"]); ?></textarea>
                   
                </td>
            </tr>
            <tr align="left"  class="center_t_d">
                <td width="20%">关键字 [keywords]</td>
                <td align="left">
                     <input type="text" size="100" name="keywords" id="keywords" value="<?php echo ($info["keywords"]); ?>" />
            ...
            <tr align="left"  class="center_t_d">
                <td width="20%">户型</td>
                <td align="left">
                    <select name="hxid" id="hxid">
                        <option value="">请选择</option>
                        <?php if(is_array($hxlist)): $i = 0; $__LIST__ = $hxlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo[id]==$info[hxid]): ?>selected<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                   </select>
                </td>
            </tr>
            <tr align="left"  class="center_t_d">
                <td width="20%">局部</td>
                <td align="left">
                    <select name="jbid" id="jbid">
                        <option value="">请选择</option>
                        <?php if(is_array($jubucategory)): $i = 0; $__LIST__ = $jubucategory;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo[id]==$info[jbid]): ?>selected<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                   </select>
                </td>
            </tr>    
             <tr align="left"  class="center_t_d">
                <td width="20%">色系</td>
                <td align="left">
                    <select name="sxid" id="sxid">
                        <option value="">请选择</option>
                        <?php if(is_array($sexi)): $i = 0; $__LIST__ = $sexi;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo[id]==$info[sxid]): ?>selected<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                   </select>
                </td>
            </tr>   
              <tr align="left"  class="center_t_d">
                <td width="20%">风格</td>
                <td align="left">
                    <select name="fgid" id="fgid">
                        <option value="">请选择</option>
                        <?php if(is_array($fglist)): $i = 0; $__LIST__ = $fglist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo[id]==$info[fgid]): ?>selected<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                   </select>
                </td>
            </tr>   
                <tr align="left"  class="center_t_d">
                <td width="20%">空间</td>
                <td align="left">
                    <select name="kjid" id="kjid">
                        <option value="">请选择</option>
                        <?php if(is_array($kjlist)): $i = 0; $__LIST__ = $kjlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo[id]==$info[kjid]): ?>selected<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                   </select>
                </td>
            </tr>   
            ...
            <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                    <select id="ysid" name="ysid">
                        <option value="">请选择</option>
                        <?php if(is_array($yslist)): $i = 0; $__LIST__ = $yslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["ysid"]); ?>" <?php if($vo[ysid]==$info[ysid]): ?>selected<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </td>
            </tr>  
            <tr align="left"  class="center_t_d">
                <td width="20%">收藏数目</td>
                <td align="left">
                    <input type="text" size="10" name="shoucang" id="shoucang" value="<?php echo ($info["shoucang"]); ?>" />
                </td>
            </tr> 
                <tr align="left"  class="center_t_d">
                <td width="20%">点击</td>
                <td align="left">
                    <input type="text" size="10" name="click" id="click" value="<?php echo ($info["click"]); ?>" />
                </td>
            </tr> 
            ...
            <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                    ...
                    <label><input type="radio" name="status" id="status" value="1" <?php if(1==$info[status]): ?>checked<?php endif; ?> />已经审核</label>
                    <label><input type="radio" name="status" id="status" value="0" <?php if(0==$info[status]): ?>checked<?php endif; ?> />未审核</label>
            ...
            <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                    ...
                    <label><input type="radio" name="is_tj" id="is_tj" value="1" <?php if(1==$info[is_tj]): ?>checked<?php endif; ?>  />推荐</label>
                    <label><input type="radio" name="is_tj" id="is_tj" value="0" <?php if(0==$info[is_tj]): ?>checked<?php endif; ?>  />普通</label>
            ...
            <input type="hidden" name="fengmian" id="yingyezhizhao" value="<?php echo ($info["fmimg"]); ?>" />
            ...
            <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                    <div id="tpjh">
                        <div class="rowtpjh">
                           <?php if(is_array($tplist)): $i = 0; $__LIST__ = $tplist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><img src="__ROOT__<?php echo ($vo); ?>" width="100" /><br/><?php endforeach; endif; else: echo "" ;endif; ?><br/>
