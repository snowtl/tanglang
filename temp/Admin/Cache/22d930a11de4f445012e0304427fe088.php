...
<div class="wrap"> <div class="header">
 ...
 <div class="tabBox" id="Threetab">
  ...
  <div class="center_r">
    <div class="center">
        <div class="center_r_t">您的位置：<a href="<?php echo U('Shop/taocan');?>" class="a1">套餐列表</a>>> <a href="<?php echo U('Shop/add_taocan');?>" class="a1">添加套餐step1</a> >>添加套餐step2</div>
      <div class="center_t">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
              <tr align="left"  class="center_t_d">
                <td width="20%">套餐名称</td>
                <td align="left">
                    <input type="text" name="tcname" id="tcname" size="100" value="<?php echo ($info["tcname"]); ?>" />
                </td>
            </tr> 
            <tr align="left"  class="center_t_d">
                <td width="20%">商品<input type="button" class="btn submit" onclick="addsp()" value="添加" id="add" name="add" /></td>
                <td align="left">
                    <div id="jia_sp">
                        <label>价格:</label><input type="text" name="price[]" id="price[]" size="10" value="" />
                        <label>商品:</label>
                        <select id="goodsid[]" name="goodsid[]">
                            <option value="">请选择</option>
                            <?php if(is_array($glist)): $i = 0; $__LIST__ = $glist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?>[本店价格：<?php echo ($vo["price"]); ?>]</option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                </td>
            </tr>   
            ...
            <tr align="left"  class="center_t_d">
              <td colspan="2">
                ...
                <input type="submit" class="btn submit" value="完成" id="sub" name="sub" /></td>
            </tr>
          </table>
        </form>
      </div>
...
<div id="jia_sp2" style="display:none;">
        <label>价格:</label><input type="text" name="price[]" id="price[]" size="10" value="" />
        <label>商品:</label>
        <select id="goodsid[]" name="goodsid[]">
        <option value="">请选择</option>
...
<script>
    function addsp(){
        var jia_sp=$("#jia_sp2").html();
        $("#jia_sp").append("<br/>"+jia_sp);
    }
            $(function() {
