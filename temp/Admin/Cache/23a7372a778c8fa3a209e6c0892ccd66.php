...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
    <title>添加-施工工地-后台管理-<?php echo ($systemConfig["SITE_INFO"]["name_cms"]); ?></title>
    <meta charset="UTF-8">
...
.rowtpjh {
 ...
 <div class="tabBox" id="Threetab">
      ...
      <div class="center_r">
        <div class="center">
          <div class="center_r_t"> 您的位置：<a href="<?php echo U('Gongzhang/list_gd');?>" class="a1">施工工地</a>>> <a href="<?php echo U('Gongzhang/add_gd');?>" class="a1">添加施工工地step1</a>>>添加施工工地step2 </div>
          <div class="center_t">
            <form action="" method="POST" id="form1" name="form1" enctype="multipart/form-data" >
              <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab center_t">
                <tr align="left"  class="center_t_d">
                  <td width="20%">工地名称</td>
                  <td align="left"><input type="text" size="100" name="name" id="name" value="" /></td>
                </tr>
