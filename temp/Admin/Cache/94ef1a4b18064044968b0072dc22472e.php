	...
	<div>
		<span style="vertical-align: top">裁切图片：</span>
            ...
            <?php if(!empty($info[yingyezhizhao])): ?><img src="__ROOT__/Uploads/product/<?php echo ($info["yingyezhizhao"]); ?>" height="100" /><?php endif; ?>
                ...
                <tr>
                    <td>email：</td>
                    <td><input type="text" name="dinfo[email]" size="100" id="email" value="<?php echo ($info[email]); ?>" /></td>
                </tr>
                <tr>
                    <td>营业时间：</td>
                    <td><input type="text" name="dinfo[yingyetime]" size="100" id="yingyetime" value="<?php echo ($info[yingyetime]); ?>" /></td>
                </tr>
...
<?php if($is_qx==0): ?><tr>
                    ...
                    <td>
                        ...
                        <select id="city_id" name="city_id" onchange="getdiqu('pro_id','city_id','q_id')">
...
<?php if($is_qx==1): ?><tr>
                    <td>区：</td>
                    <td>
                        <input type="hidden" id="pro_id" name="pro_id" value="<?php echo ($p_id); ?>" />
                        <input type="hidden" id="city_id" name="city_id" value="<?php echo ($c_id); ?>" />
                        <select id="q_id" name="q_id">
                ...
                <tr>
                    <td>地址：</td>
                    <td><input type="text" name="dinfo[address]" size="100" id="address" value="<?php echo ($info[address]); ?>" /></td>
                </tr>
    ...
    document.getElementById("weidu").value=e.point.lat;
                ...
                <tr>
                    <td>服务宗旨：</td>
                    <td><input type="text" name="dinfo[fwzz]" size="100" id="fwzz" value="<?php echo ($info[fwzz]); ?>" /></td>
                </tr>
                <tr>
                    <td>展厅面积：</td>
                    <td><input type="text" name="dinfo[ztmj]" size="10" id="ztmj" value="<?php echo ($info[ztmj]); ?>" /></td>
                </tr>
                <tr>
                    <td>服务承诺：</td>
                    <td><input type="text" name="dinfo[fwcn]" size="100" id="fwcn" value="<?php echo ($info[fwcn]); ?>" /></td>
                </tr>
                <tr>
                    <td>店铺简介：</td>
                    <td>
                    <textarea id="comjianjie" name="comjianjie" cols="100" rows="5"><?php echo ($info[comjianjie]); ?></textarea>
                    </td>
                </tr>
                <tr>
                    <td>公司介绍：</td>
                    <td>
                    <textarea id="comcontent" name="comcontent" class="ckeditor" cols="100" rows="5"><?php echo ($info[comcontent]); ?></textarea>
                    </td>
                </tr>
                <tr>
                    <td>分店数目：</td>
                    <td><input type="text" name="dinfo[fdnum]" size="10" id="fdnum" value="<?php echo ($info[fdnum]); ?>" /></td>
                </tr>
                <tr>
                    <td>排序：</td>
                    <td><input type="text" name="dinfo[orders]" size="10" id="orders" value="<?php echo ($info[orders]); ?>" /></td>
                </tr>
                <tr>
                    <td>点击次数：</td>
                    <td><input type="text" name="dinfo[click]" size="10" id="click" value="<?php echo ($info[click]); ?>" /></td>
                </tr>
                <tr>
                    <td>推荐：</td>
                    <td>
                    <label><input type="radio" name="dinfo[is_tj]" id="is_tj" value="1" <?php if($info[is_tj]==1): ?>checked<?php endif; ?> />推荐</label>
                    <label><input type="radio" name="dinfo[is_tj]" id="is_tj" value="0" <?php if($info[is_tj]==0): ?>checked<?php endif; ?> />普通</label>
                    </td>
                </tr>
                <tr>
                    <td>导航图：</td>
                    ...
                    <?php if(!empty($info[dhimg])): ?><img src="<?php echo ($systemConfig["SITE_INFO"]["url"]); ?>/Uploads/shangjia/<?php echo ($info["dhimg"]); ?>" width="100"/><?php endif; ?>
                    </td>
                </tr>
                <tr>
                    <td>温馨提示：</td>
                    <td>
                    <textarea id="wxts" name="wxts" cols="100" rows="5"><?php echo ($info[wxts]); ?></textarea>
                    </td>
                </tr>
