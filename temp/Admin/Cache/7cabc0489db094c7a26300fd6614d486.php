...
<head>
<title>预算列表-后台管理-<?php echo ($systemConfig["SITE_INFO"]["name_cms"]); ?></title>
<meta charset="UTF-8">
...
<div class="wrap"> <div class="header">
 ...
 <div class="tabBox" id="Threetab">
  ...
  <div class="center_r">
    <div class="center">
      <div class="center_r_t">您的位置：<a href="<?php echo U('Yusuan/index');?>" class="a1">预算列表</a>>>添加预算</div>
      <div class="center_t">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
            <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                    ...
                    <textarea name="name" id="name" cols="100" rows="10"><?php echo ($info["name"]); ?></textarea>
                    <br/>
                    <?php if(empty($info[ysid])): ?>提示:添加多个预算,按Enter键<?php endif; ?>
                </td>
            </tr>
            <tr align="left"  class="center_t_d">
              <td colspan="2"><input type="hidden" id="id" name="id" value="<?php echo ($info["ysid"]); ?>" />   
