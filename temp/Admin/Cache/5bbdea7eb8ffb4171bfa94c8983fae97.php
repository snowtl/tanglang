...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
    <title>添加文章-后台管理-<?php echo ($systemConfig["SITE_INFO"]["name_cms"]); ?></title>
    <meta charset="UTF-8">
...
.rowtpjh {
 ...
 <div class="tabBox" id="Threetab">
      ...
      <div class="center_r">
        <div class="center">
          <div class="center_r_t"> 您的位置：<a href="<?php echo U('Article/index');?>" class="a1">文章列表</a>>>添加文章 </div>
          <div class="center_t">
            <form action="" method="POST" id="form1" name="form1" enctype="multipart/form-data" >
              <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab center_t">
                  ...
                  <td width="20%">会员</td>
                  <td align="left"><select id="uid" name="uid">
                      <option value="">请选择</option>
                      <?php if(is_array($ulist)): $i = 0; $__LIST__ = $ulist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["a_id"]); ?>" <?php if($info[uid]==$vo[a_id]): ?>selected<?php endif; ?> ><?php echo ($vo["a_name"]); ?>[<?php echo ($vo["truename"]); ?>]</option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select></td>
                </tr>
                <tr align="left"  class="center_t_d">
                  <td width="20%">标题</td>
                  <td align="left"><input type="text" size="100" name="title" id="title" value="<?php echo ($info["title"]); ?>" /></td>
                </tr>
                
                <tr align="left"  class="center_t_d">
                  <td width="20%">分类</td>
                  <td align="left"><select id="classid" name="classid">
                      <option value="">请选择</option>
                      <?php if(is_array($artlist)): $i = 0; $__LIST__ = $artlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["cid"]); ?>" <?php if($info[classid]==$vo[cid]): ?>selected<?php endif; ?> ><?php echo ($vo["fullname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select></td>
                </tr>
               
                <tr align="left"  class="center_t_d">
                  <td width="20%">描述 [description]</td>
                  <td align="left"><textarea id="description" name="description" rows="10" cols="50"><?php echo ($info["description"]); ?></textarea></td>
                </tr>
                <tr align="left"  class="center_t_d">
                  <td width="20%">关键字 [keywords]</td>
                  <td align="left"><input type="text" size="100" name="keywords" id="keywords" value="<?php echo ($info["keywords"]); ?>" /></td>
                </tr>
                ...
                <tr align="left"  class="center_t_d">
                  ...
                  <td width="20%">推荐</td>
                  <td align="left"><label>
                      <input type="radio" name="is_tj" id="is_tj" value="1" <?php if($info[is_tj]==1): ?>checked<?php endif; ?> />
                      推荐</label>
                    <label>
                      <input type="radio" name="status" id="status" value="0" <?php if($info[is_tj]==0): ?>checked<?php endif; ?> />
                      普通</label></td>
                </tr>
                  <tr align="left"  class="center_t_d">
                  <td width="20%">点击</td>
                  <td align="left">
                          <input type="input" name="click" size="10" id="click" value="<?php echo ($info["click"]); ?>" />
                ...
                <tr align="left"  class="center_t_d">
                  ...
                  <td align="left"><input id="file_upload" name="file_upload" type="file" multiple="true">
                    ...
                    <?php if(!empty($info[fmimg])): ?><img src="__ROOT__<?php echo ($info["fmimg"]); ?>" height="100" /><?php endif; ?></td>
                </tr>
                <tr align="left"  class="center_t_d">
                  <td width="20%">内容</td>
                  <td align="left"><textarea id="jianjie" name="content" rows="10" cols="50"><?php echo ($info["content"]); ?></textarea></td>
                </tr>
                <tr>
                  <td colspan="2">
