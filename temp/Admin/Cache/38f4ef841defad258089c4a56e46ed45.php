...
<head>
<title>添加/编辑 合影-后台管理-<?php echo ($systemConfig["SITE_INFO"]["name_cms"]); ?></title>
<meta charset="UTF-8">
...
<div class="wrap"> <div class="header">
 ...
 <div class="tabBox" id="Threetab">
  ...
  <div class="center_r">
    <div class="center">
      <div class="center_r_t">您的位置：<a href="<?php echo U('Heying/index');?>" class="a1">合影列表</a>>>添加/编辑 合影</div>
      <div class="center_t">
            ...
            <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                    ...
                    <select id="gzid" name="gzid">
                        ...
                        <?php if(is_array($gzlist)): $i = 0; $__LIST__ = $gzlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["a_id"]); ?>" <?php if($info[uid]==$vo[a_id]): ?>selected<?php endif; ?> ><?php echo ($vo["a_name"]); ?>[<?php echo ($vo["truename"]); ?>]</option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </td>
            </tr>
             <tr align="left"  class="center_t_d">
                <td width="20%">合影名称</td>
                <td align="left">
                    <input type="text" name="name" size="100" id="name" value="<?php echo ($info["name"]); ?>" />
                </td>
            </tr> 
             <tr align="left"  class="center_t_d">
                <td width="20%">合影图片</td>
                <td align="left">
                    ...
                    <?php if(!empty($info[img])): ?><img src="<?php echo ($systemConfig["SITE_INFO"]["url"]); echo ($info["img"]); ?>" width="100" /><?php endif; ?>
                </td>
            </tr> 
             ...
             <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                    <label><input type="radio" id="is_tj" name="is_tj" value="1" <?php if($info[is_tj]==1): ?>checked<?php endif; ?> />是</label>
                    <label><input type="radio" id="is_tj" name="is_tj" value="0" <?php if($info[is_tj]==0): ?>checked<?php endif; ?> />否</label>
                </td>
            </tr> 
             ...
             <tr align="left"  class="center_t_d">
                <td width="20%">状态</td>
                <td align="left">
                    <label><input type="radio" id="status" name="status" value="1" <?php if($info[status]==1): ?>checked<?php endif; ?> />已经审核</label>
                    <label><input type="radio" id="status" name="status" value="0" <?php if($info[status]==0): ?>checked<?php endif; ?>  />未审核</label>
                </td>
            </tr> 
    ...
    function xzgz(){
        ...
        $.ajax({
            ...
            type:"post",
            datatype:"json",
            url:"<?php echo U('Gongzhang/ajaxgetgz');?>",
