...
<html>
<head>
<title>回复留言-后台管理-<?php echo ($systemConfig["SITE_INFO"]["name_cms"]); ?></title>
<meta charset="UTF-8">
...
<div class="wrap"> <div class="header">
  ...
  <div class="center_r">
    <div class="center">
        <div class="center_r_t">您的位置：<a href="<?php echo U('Shop/message');?>" class="a1" >回复留言列表</a> >>回复回复留言</div>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="center_t" style="word-break:break-all; word-wrap:break-all;">
        ...
        <tr class="center_t_d">
          ...
          <td><?php echo ($info["lycontent"]); ?></td>
        </tr>
        <tr class="center_t_d">
          <td width="135">留言类型：</td>
          <td><?php echo ($lytype); ?></td>
        </tr>
        <tr class="center_t_d">
          <td width="135">商家：</td>
          <td><?php echo ($sj); ?></td>
        ...
        <tr class="center_t_d">
          <td width="135">留言时间：</td>
          <td><?php echo ($addtimef); ?></td>
        </tr>
        <tr class="center_t_d">
          <td width="135">回复：</td>
