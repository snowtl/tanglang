...
<head>
<title>商城分类-后台管理-<?php echo ($systemConfig["SITE_INFO"]["name_cms"]); ?></title>
<meta charset="UTF-8">
...
<div class="wrap"> <div class="header">
 ...
 <div class="tabBox" id="Threetab">
  ...
  <div class="center_r">
    <div class="center">
      <div class="center_r_t">您的位置：<a href="<?php echo U('Shop/shopcategory');?>" class="a1">商城分类</a>>>添加分类</div>
      <div class="center_t">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
            <tr align="left"  class="center_t_d">
                <td width="20%">名称</td>
                <td align="left">
                    <input type="text" size="100" name="cname" id="cname" value="<?php echo ($info["cname"]); ?>" />
                </td>
            </tr>
            <tr align="left"  class="center_t_d">
                <td width="20%">分类图标</td>
                <td align="left">
                    <input type="file" name="clogo" id="clogo" value="" />
                    <?php if(!empty($info[clogo])): ?><img src="<?php echo ($systemConfig["SITE_INFO"]["url"]); echo ($info["clogo"]); ?>" width="100"/><?php endif; ?>
                </td>
            </tr>
            <tr align="left"  class="center_t_d">
                <td width="20%">上级分类</td>
                <td align="left">
                    <select id="pid" name="pid">
                        ...
                        <?php if(is_array($sclist)): $i = 0; $__LIST__ = $sclist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["cid"]); ?>" <?php if($vo[cid]==$info[pid]): ?>selected<?php endif; ?>><?php echo ($vo["fullname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </td>
            </tr>
                
            <tr align="left"  class="center_t_d">
              <td colspan="2"><input type="hidden" id="cid" name="cid" value="<?php echo ($info["cid"]); ?>" />   
