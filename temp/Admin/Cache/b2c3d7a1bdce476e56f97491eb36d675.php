...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        <title>添加/编辑-视频-后台管理-<?php echo ($systemConfig["SITE_INFO"]["name_cms"]); ?></title>
        <meta charset="UTF-8">
 ...
 <div class="tabBox" id="Threetab">
  ...
  <div class="center_r">
    <div class="center">
      ...
      您的位置：<a href="<?php echo U('Shipin/index');?>" class="a1">视频列表</a>>>添加/编辑视频
      </div>
      <div class="center_t">
          <form action="" method="POST" id="form1" name="form1" enctype="multipart/form-data" >
            ...
            <tr align="left"  class="center_t_d">
                <td width="20%">会员</td>
                <td align="left">
                    <select id="type" name="type" onchange="gbmember(this.value)">
                        <option value="">请选择类型</option>
                        <?php if(is_array($tplist)): $k = 0; $__LIST__ = $tplist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><option value="<?php echo ($k); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </td>
            </tr>
            <tr align="left"  class="center_t_d">
           ...
           <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                    ...
                    <select id="gzid" name="gzid">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["a_id"]); ?>"><?php echo ($vo["a_name"]); ?>[<?php echo ($vo["truename"]); ?>]</option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </td>
            </tr><?php endif; ?> 
            <tr align="left"  class="center_t_d">
            ...
            <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                    ...
                    <textarea id="spcontent" name="spcontent" placeholder="将优酷的视频代码复制到此处或者在下面上传视频" rows="10" cols="50"><?php echo ($info["spcontent"]); ?></textarea><br/>
                    <input type="file" name="spurl" id="spurl" />[只可上传flv格式文件]
                    <?php echo ($info["spurl"]); ?>
                </td>
            </tr>
                <tr align="left"  class="center_t_d">
