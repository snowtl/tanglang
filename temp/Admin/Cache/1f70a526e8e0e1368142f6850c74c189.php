...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
    <title>添加-装修案例-后台管理-<?php echo ($systemConfig["SITE_INFO"]["name_cms"]); ?></title>
    <meta charset="UTF-8">
...
.rowtpjh {
 ...
 <div class="tabBox" id="Threetab">
      ...
      <div class="center_r">
        <div class="center">
          <div class="center_r_t"> 您的位置：<a href="<?php echo U('Gongzhang/list_case');?>" class="a1">装修案例</a>>> <a href="<?php echo U('Gongzhang/add_case');?>" class="a1">添加装修案例step1</a>>>添加装修案例step2 </div>
          <div class="center_t">
            <form action="" method="POST" id="form1" name="form1" enctype="multipart/form-data" >
              <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab center_t">
                <tr align="left"  class="center_t_d">
                  <td width="20%">标题</td>
                  <td align="left"><input type="text" size="100" name="title" id="title" value="" /></td>
                </tr>
                <tr align="left"  class="center_t_d">
                  <td width="20%">是否是经典案例</td>
                  <td align="left"><label>
                      <input type="radio" name="is_jd" id="is_jd" value="1" />
                      经典</label>
                    <label>
                      <input type="radio" name="is_jd" id="is_jd" value="0" />
                      普通</label></td>
                </tr>
                <tr align="left"  class="center_t_d">
                  <td width="20%">户型</td>
                  <td align="left"><select id="hid" name="hid">
                      <option value="">请选择</option>
                      <?php if(is_array($hxcategory)): $i = 0; $__LIST__ = $hxcategory;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" ><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select></td>
                </tr>
                <tr align="left"  class="center_t_d">
                  <td width="20%">风格</td>
                  <td align="left"><select id="hid" name="fid">
                      <option value="">请选择</option>
                      <?php if(is_array($fgcategory)): $i = 0; $__LIST__ = $fgcategory;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" ><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select></td>
                </tr>
                <tr align="left"  class="center_t_d">
                  <td width="20%">价格 
                  </td>
                  <td align="left"><input type="text" size="30" name="price" id="price" value="" />
                    元 </td>
                </tr>
                <tr align="left"  class="center_t_d">
                  <td width="20%">面积 
                  </td>
                  <td align="left"><input type="text" size="30" name="mianji" id="mianji" value="" />
                    平方米 </td>
                </tr>
                <tr align="left"  class="center_t_d">
                ...
                <tr align="left"  class="center_t_d">
                  ...
                  <td align="left"><input type="text" size="100" name="keywords" id="keywords" value="" /></td>
                </tr>
                <tr align="left"  class="center_t_d">
                  <td width="20%">好评数</td>
                  <td align="left"><input type="text" size="10" name="goods" id="goods" value="" /></td>
                </tr>
                <tr align="left"  class="center_t_d">
                  <td width="20%">评论数目</td>
                  <td align="left"><input type="text" size="10" name="comments" id="comments" value="" /></td>
                </tr>
                <tr align="left"  class="center_t_d">
                  <td width="20%">状态</td>
                  <td align="left"><label>
                ...
                <tr align="left"  class="center_t_d">
                  ...
                  <td align="left"><input id="file_upload" name="file_upload" type="file" multiple="true">
                    <div id="some_file_queue"> </div>
                    <div class="imgList" id="image"></div>
                    <input type="hidden" name="fengmian" id="yingyezhizhao" value="<?php echo ($info["yingyezhizhao"]); ?>" />
                    <?php if(!empty($info[yingyezhizhao])): ?><img src="__ROOT__/Uploads/product/<?php echo ($info["yingyezhizhao"]); ?>" height="100" /><?php endif; ?></td>
                </tr>
                <?php if(is_array($tpjhlist)): $k = 0; $__LIST__ = $tpjhlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr align="left"  class="center_t_d">
                    ...
                    <td align="left"><div id="tpjh_<?php echo ($vo["id"]); ?>">
                        <div class="rowtpjh">
                ...
                <tr align="left"  class="center_t_d">
                  <td width="20%">简介</td>
                  <td align="left"><textarea id="jianjie" name="jianjie" rows="10" cols="50"></textarea></td>
                </tr>
                <tr>
                  <td colspan="2"><input type="hidden" name="step" id="step" value="<?php echo ($step); ?>" />
                    <input type="hidden" name="gzid" id="gzid" value="<?php echo ($gzid); ?>" />
