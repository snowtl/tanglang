...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
    <title>添加-设计案例-后台管理-<?php echo ($systemConfig["SITE_INFO"]["name_cms"]); ?></title>
    <meta charset="UTF-8">
...
.rowtpjh {
 ...
 <div class="tabBox" id="Threetab">
      ...
      <div class="center_r">
        <div class="center">
          <div class="center_r_t"> 您的位置：<a href="<?php echo U('Sheji/index');?>" class="a1">设计案例</a>>> <a href="<?php echo U('Sheji/add_sj_case');?>" class="a1">添加设计案例step1</a>>>添加设计案例step2 </div>
          <div class="center_t">
