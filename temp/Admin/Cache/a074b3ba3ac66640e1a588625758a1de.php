...
jQuery(document).ready(function($) {
	$('.theme-login').click(function(){
		window.location.href="<?php echo U('Shop/add_taocan');?>";
	})
    ...
    <div class="center">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="center_t" style="word-break:break-all; word-wrap:break-all;">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="center_t_d">
          ...
          <td width="135" ondblclick="updatename('<?php echo ($vo["id"]); ?>','<?php echo ($vo["tcname"]); ?>')" id="t_<?php echo ($vo["id"]); ?>"><?php echo ($vo["tcname"]); ?></td>
          <td width="135"><?php echo ($vo["p_name"]); ?>/<?php echo ($vo["c_name"]); ?></td>
          <td width="50"><?php echo ($vo["company"]); ?></td>
         
          <td width="135">
              
              
              <a name="<?php echo ($vo["tcname"]); ?>" link="<?php echo U('Shop/del_taocan',array('id'=>$vo[id]));?>" style="cursor:pointer" class="del">删除</a></td>
