...
<div class="wrap"> <div class="header">
 ...
 <div class="tabBox" id="Threetab">
  ...
  <div class="center_r">
    <div class="center">
      <div class="center_r_t">您的位置：<a href="<?php echo U('Ad/adlist');?>" class="a1">广告列表</a>>>添加广告</div>
      <div class="center_t">
        <form action="" method="POST" id="form1" name="form1" enctype="multipart/form-data">
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
            <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                    <input type="text" name="title" id="name" size="100" value="<?php echo ($info["title"]); ?>" />
                </td>
            </tr>
            <tr align="left"  class="center_t_d">
            ...
            <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                    <select id="weizhi" name="weizhi">
                        ...
                        <?php if(is_array($wzlist)): $i = 0; $__LIST__ = $wzlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($info[weizhi]==$vo[id]): ?>selected<?php endif; ?> ><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </td>
            </tr>
             ...
             <tr align="left"  class="center_t_d">
              ...
              <tr align="left"  class="center_t_d">
                ...
                <td align="left">
                    ...
                    <?php if(!empty($info[img])): ?><a href="<?php echo ($systemConfig["SITE_INFO"]["url"]); echo ($info["img"]); ?>" target="_blank"> <img src="__ROOT__<?php echo ($info[img]); ?>" width="100"  title="查看大图"/></a><?php endif; ?>
                </td>
            </tr>   
