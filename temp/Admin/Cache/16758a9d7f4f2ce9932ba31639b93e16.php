...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        <title>编辑施工动态-后台管理-<?php echo ($systemConfig["SITE_INFO"]["name_cms"]); ?></title>
        <meta charset="UTF-8">
 ...
 <div class="tabBox" id="Threetab">
  ...
  <div class="center_r">
    <div class="center">
      ...
      您的位置：<a href="<?php echo U('Gongzhang/index');?>" class="a1">施工动态</a>>>编辑施工动态
      </div>
      <div class="center_t">
          <form action="" method="POST" id="form1" name="form1" enctype="multipart/form-data" >
            ...
            <tr align="left"  class="center_t_d">
                <td width="20%">概述</td>
                <td align="left">
                    <textarea id="gaishu" name="gaishu" rows="10" cols="50"><?php echo ($info["gaishu"]); ?></textarea>
            ...
            <tr align="left"  class="center_t_d">
                <td width="20%">预算</td>
                <td align="left">
                    <input type="text" size="10" name="yusuan" id="yusuan" value="<?php echo ($info["yusuan"]); ?>" />万元
                </td>
            </tr>  
            <tr align="left"  class="center_t_d">
                <td width="20%">业主姓名</td>
                <td align="left">
                    <input type="text" size="10" name="yezhu" id="yezhu" value="<?php echo ($info["yezhu"]); ?>" />
                </td>
            </tr> 
            <tr align="left"  class="center_t_d">
                <td width="20%">施工阶段</td>
                <td align="left">
                    ...
                    <select id="jieduan" name="jieduan">
                        <?php if(is_array($jd)): $k = 0; $__LIST__ = $jd;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><option value="<?php echo ($k); ?>" <?php if($info[jieduan]==$k): ?>selected<?php endif; ?> ><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </td>
            </tr> 
            <tr align="left"  class="center_t_d">
                <td width="20%">排序</td>
                <td align="left">
                    <input type="text" size="10" name="sort" id="sort" value="<?php echo ($info["sort"]); ?>" />
